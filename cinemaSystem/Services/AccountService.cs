using cinemaSystem.Areas.Identity.Controllers;
    ...
    public class AccountService : IAccountService
    {
       ...
       private readonly IRepository<ApplicationUserOTP> _applicationUserOTPRepository;
        ...
        public async Task SendMailAsync(ApplicationUser user, IUrlHelper url, HttpRequest request, EmailType emailType = EmailType.Register)
        {
            ...
            var link = url.Action(nameof(AccountController.Confirm), "AccountController", new { area =" Identity ", token, user.Id }, request.Scheme);
